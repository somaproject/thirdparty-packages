...
struct t_fastconv_base<T, ImplCbe> : fastconv_ops
{
		...
		length_type loop, float& time)
  {
    ...
    typedef vsip::impl::cbe::Fastconv<1, T, complex_type>   fconv_type;
...
struct t_fastconv_base<T, ImplCbe_ip<ComplexFmt, single_fc> > : fastconv_ops
{
  ...
  typedef vsip::impl::cbe::Fastconv<1, T, ComplexFmt>   fconv_type;
...
{
  typedef vsip::impl::Layout<1, row1_type, vsip::impl::Stride_unit_dense,
		             ComplexFmt> LP1;
  typedef vsip::impl::Layout<2, row2_type, vsip::impl::Stride_unit_dense,
			     ComplexFmt> LP2;
  typedef vsip::impl::Fast_block<1, T, LP1, Local_map> block1_type;
  typedef vsip::impl::Fast_block<2, T, LP2, Local_map> block2_type;
...
struct t_fastconv_base<T, ImplCbe_multi<transform_replica> > : fastconv_ops
{
  ...
  typedef vsip::impl::dense_complex_type complex_type;
  typedef vsip::impl::cbe::Fastconv<2, T, complex_type>   fconvm_type;
