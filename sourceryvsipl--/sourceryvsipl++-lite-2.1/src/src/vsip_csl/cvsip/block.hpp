...
*/
/** @file    vsip_csl/cvsip/block.hpp
    @author  Stefan Seefeld
    @date    2008-05-02
    @brief   the C-VSIP block API.
*/
...
// (admitting, releasing) user-storage. Here we access Dense<>::impl_data(),
...
public:
  ...
  typename S::type impl_data() 
  { return impl::offset(storage_.impl_data(), offset_);}
  typename S::const_type impl_data() const 
  { return impl::offset(storage_.impl_data(), offset_);}
  vsip::stride_type impl_stride(vsip::dimension_type, vsip::dimension_type) const 
  { return stride_;}
...
public:
  ...
  typename S::const_type impl_data() const
  { return impl::offset(storage_.impl_data(), offset_);}
  vsip::stride_type impl_stride(vsip::dimension_type D, vsip::dimension_type d) const
...
struct Block_layout<vsip_csl::cvsip::Block<D, S> >
{
  ...
  typedef typename S::complex_type complex_type;
