...
/** @file    vsip_csl/stencil.hpp
    @author  Stefan Seefeld
    @date    2007-04-16
    @brief   VSIPL++ Library: Stencil support classes.

*/

#ifndef VSIP_CSL_STENCIL_HPP
#define VSIP_CSL_STENCIL_HPP
...
#include <vsip_csl/stencil/boundary_factory.hpp>
#include <vsip_csl/stencil/expr.hpp>
#include <vsip_csl/stencil/bounds_finder.hpp>
#include <vsip_csl/stencil/kernel_builder.hpp>
