...
template <symmetry_type       S,
	  ...
	  unsigned            N,
          alg_hint_type       H>
struct Evaluator<Conv_tag<1, S, R, float, N, H>, Mercury_sal_tag>
{
  static bool const ct_valid = true;
  typedef sal::Convolution<const_Vector, S, R, float, N, H> backend_type;
};
template <symmetry_type       S,
	  support_region_type R,
	  unsigned            N,
          alg_hint_type       H>
struct Evaluator<Conv_tag<1, S, R, std::complex<float>, N, H>, Mercury_sal_tag>
{
  static bool const ct_valid = true;
  typedef sal::Convolution<const_Vector, S, R, std::complex<float>, N, H> backend_type;
};
template <symmetry_type       S,
	  support_region_type R,
	  unsigned            N,
          alg_hint_type       H>
struct Evaluator<Conv_tag<2, S, R, float, N, H>, Mercury_sal_tag>
{
  static bool const ct_valid = true;
  typedef sal::Convolution<const_Matrix, S, R, float, N, H> backend_type;
};
