...
/** @file    src/vsip/opt/ukernel/kernels/host/vcopy.hpp
    @author  Jules Bergmann
    @date    2008-06-18
    @brief   VSIPL++ Library: Vector copy Ukernel
*/

#ifndef VSIP_SRC_OPT_UKERNEL_KERNELS_HOST_VCOPY_HPP
#define VSIP_SRC_OPT_UKERNEL_KERNELS_HOST_VCOPY_HPP
...
class Copy_ukernel : public vsip::impl::ukernel::Host_kernel_base
{
  // Parameters.
...
DEFINE_UKERNEL_TASK(Copy_ukernel, void(float*, float*), "uk_plugin", vcopy_f)

#endif // VSIP_SRC_OPT_UKERNEL_KERNELS_HOST_VCOPY_HPP
