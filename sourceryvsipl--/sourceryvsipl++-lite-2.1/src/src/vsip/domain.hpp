...
/** @file    vsip/domain.hpp
    @author  Stefan Seefeld, Nathan Myers
    @date    2005-01-20
    @brief   VSIPL++ Library: [domains] Domain type and related functions.

    This file declares the Domain type and associated functions as 
    specified in the [domain] section of the VSIPL++ specification.
*/
