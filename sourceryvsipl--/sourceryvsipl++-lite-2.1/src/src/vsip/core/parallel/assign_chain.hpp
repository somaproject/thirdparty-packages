...
/** @file    vsip/core/parallel/chain_assign.hpp
...
#ifndef VSIP_IMPL_PAR_CHAIN_ASSIGN_HPP
#define VSIP_IMPL_PAR_CHAIN_ASSIGN_HPP
...
#undef VSIP_IMPL_PCA_ROTATE

#endif // VSIP_IMPL_PAR_CHAIN_ASSIGN_HPP
