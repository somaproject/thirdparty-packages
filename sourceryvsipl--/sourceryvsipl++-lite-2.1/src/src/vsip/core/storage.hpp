...
/** @file    vsip/core/storage.hpp
    @author  Jules Bergmann
    @date    2005-04-08
    @brief   VSIPL++ Library: Data storage within a block.
*/

#ifndef VSIP_CORE_STORAGE_HPP
#define VSIP_CORE_STORAGE_HPP
...
struct Storage
{
  ...
  // Used by block-copy
  static T    get(type data, index_type idx)        { return data[idx]; }
...
struct Storage<Cmplx_split_fmt, vsip::complex<T> >
{
  ...
  // Used by block-copy
  static complex<T> get(type data, index_type idx)
