...
struct Unary_func_return_type
{
  ...
  typedef const Unary_expr_block<View<Type, Block>::dim,
				 Functor, Block, Type> block_type;
...
struct Binary_func_return_type
{
  ...
  typedef const Binary_expr_block<View1<Type1, Block1>::dim, Functor,
				Block1, Type1,
				Block2, Type2> block_type;
...
struct Ternary_func_return_type
{
  ...
  typedef const Ternary_expr_block<View1<Type1, Block1>::dim,
			 	 Functor,
				 Block1, Type1,
				 Block2, Type2,
				 Block3, Type3> block_type;
			...
			S>
{
  ...
  typedef Scalar_block<dim, S> scalar_block_type;
			...
			View<Type, Block> >
{
  static dimension_type const dim = View<Type, Block>::dim;
  typedef Scalar_block<dim, S> scalar_block_type;
  typedef Binary_func_return_type<View, S, scalar_block_type,
                                  View, Type, Block,
                                  Functor> type_trait;
			 ...
			 View2<Type2, Block2> >
{
  static dimension_type const dim = View1<Type1, Block1>::dim;
  typedef Scalar_block<dim, S> scalar_block_type;
  typedef Ternary_func_return_type<View1, S, scalar_block_type,
				   View1, Type1, Block1,
				   View2, Type2, Block2,
				   Functor> type_trait;
...
{
  static dimension_type const dim = View<Type, Block>::dim;
  typedef Scalar_block<dim, S1> scalar_block1_type;
  typedef Scalar_block<dim, S2> scalar_block2_type;
  typedef Ternary_func_return_type<View, Type, Block,
				   View, S1, scalar_block1_type,
				   View, S2, scalar_block2_type,
				   Functor> type_trait;
			 ...
			 S2>
{
  ...
  typedef Scalar_block<dim, S1> scalar_block1_type;
  typedef Scalar_block<dim, S2> scalar_block2_type;
  typedef Ternary_func_return_type<View, S1, scalar_block1_type,
				   View, Type, Block,
				   View, S2, scalar_block2_type,
				   Functor> type_trait;
