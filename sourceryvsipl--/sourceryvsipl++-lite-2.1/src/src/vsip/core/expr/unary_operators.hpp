...
struct Unary_operator_return_type
{
  ...
  typedef const Unary_expr_block<View<Type, Block>::dim,
			       Operator, Block, Type> block_type;
...
template <template <typename, typename> class View,
	  ...
	  typename Block>
inline
typename Unary_operator_return_type<View, Type, Block, op::Plus>::view_type
operator+(View<Type, Block> const& view)
{
  typedef Unary_operator_return_type<View, Type, Block, op::Plus> type_trait;
...
template <template <typename, typename> class View,
	  ...
	  typename Block>
inline
typename Unary_operator_return_type<View, Type, Block, op::Minus>::view_type
operator-(View<Type, Block> const& view)
{
  typedef Unary_operator_return_type<View, Type, Block, op::Minus> type_trait;
