...
unary(F f, View<T, Block> v)
{
  ...
  return view_type(block_type(v.block(), Function(f)));
}
...
unary(F f, View<T, Block> v)
{
  ...
  return view_type(block_type(v.block(), std::ptr_fun(f)));
}
...
binary(F f, View<LType, LBlock> v1, View<RType, RBlock> v2)
{
  typedef typename impl::Binary_function<R, F>
    ::template Type<LType, RType> Function;
  typedef impl::Binary_operator_return_type<
    View, LType, LBlock,
    View, RType, RBlock,
    impl::Binary_function<R, F>::template Type> type_trait;
  typedef typename type_trait::block_type block_type;
  typedef typename type_trait::view_type view_type;

  return view_type(block_type(v1.block(), v2.block(), Function(f)));
}
...
template <typename R,
	  ...
	  typename RType, typename RBlock>
typename 
impl::Binary_operator_return_type<View, 
				  LType, LBlock,
				  View,
				  RType, RBlock,
		 		  impl::Binary_function<R, R(*)(LType, RType)>
::template Type>::view_type
binary(R(*f)(LType, RType), View<LType, LBlock> v1, View<RType, RBlock> v2)
{
  typedef typename impl::Binary_function<R, R(*)(LType, RType)>
    ::template Type<LType, RType> Function;
  typedef impl::Binary_operator_return_type<View,
                                            LType, LBlock,
                                            View,
                                            RType, RBlock,
    impl::Binary_function<R, R(*)(LType, RType)>::template Type> type_trait;
  typedef typename type_trait::block_type block_type;
  typedef typename type_trait::view_type view_type;
...
template <typename F,
	  ...
	  typename RType, typename RBlock>
typename 
impl::Binary_operator_return_type<
  View, LType, LBlock,
  View, RType, RBlock,
  impl::Binary_function<typename F::result_type, F>
    ::template Type>::view_type
binary(F f, View<LType, LBlock> v1, View<RType, RBlock> v2)
{
  typedef typename impl::Binary_function<typename F::result_type, F>
    ::template Type<typename F::first_argument_type,
                    typename F::second_argument_type> Function;
  typedef impl::Binary_operator_return_type<
    View, LType, LBlock,
    View, RType, RBlock,
    impl::Binary_function<typename F::result_type, F>::template Type> type_trait;
  typedef typename type_trait::block_type block_type;
  typedef typename type_trait::view_type view_type;
	...
	View<Type3, Block3> v3)
{
  ...
  return view_type(block_type(v1.block(), v2.block(), v3.block(), Function(f)));
}
