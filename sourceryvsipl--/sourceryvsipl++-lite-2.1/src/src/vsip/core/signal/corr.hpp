...
template <dimension_type D,
          ...
          unsigned int N,
          alg_hint_type H>
struct List<Corr_tag<D, R, T, N, H> >
{
  typedef Make_type_list<Cml_tag, Opt_tag, Cvsip_tag, Generic_tag>::type type;
};
...
class Correlation
  : public impl::profile::Accumulator<impl::profile::signal>,
    ...
    public impl::dispatcher::Dispatcher<
             impl::dispatcher::Corr_tag<impl::Dim_of_view<ConstViewT>::dim,
                                        Supp,
                                        T,
                                        N_times,
                                        A_hint> >::backend_type
