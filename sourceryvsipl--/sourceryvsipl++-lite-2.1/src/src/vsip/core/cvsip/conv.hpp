...
template <symmetry_type       S,
	  ...
	  unsigned            N,
          alg_hint_type       H>
struct Evaluator<Conv_tag<1, S, R, float, N, H>, Cvsip_tag>
{
...
template <symmetry_type       S,
	  ...
	  unsigned            N,
          alg_hint_type       H>
struct Evaluator<Conv_tag<2, S, R, float, N, H>, Cvsip_tag>
{
  static bool const ct_valid = true;
...
template <symmetry_type       S,
	  ...
	  unsigned            N,
          alg_hint_type       H>
struct Evaluator<Conv_tag<1, S, R, double, N, H>, Cvsip_tag>
{
  static bool const ct_valid = true;
...
template <symmetry_type       S,
	  ...
	  unsigned            N,
          alg_hint_type       H>
struct Evaluator<Conv_tag<2, S, R, double, N, H>, Cvsip_tag>
{
  static bool const ct_valid = true;
