...
/** @file    tests/parallel/subviews.cpp
    ...
    @date    2005-07-07
    @brief   VSIPL++ Library: Unit tests for distributed subviews.
*/
  ...
  MapT const&      map)
{
  ...
  global_view1_t chk_sum(sum_size);
  chk_sum = root_sum;
  ...
  global_view1_t my_sum(dom[1].size(), T());
  ...
  MapT const&      map)
{
  ...
  global_view1_t my_sum(sum_size, T());
...
struct V_slice<0>
{
  ...
  template <typename T,
	    typename Block>
  typename Tensor<T, Block>::template subvector<1, 2>::impl_type
...
struct V_slice<1>
{
  ...
  template <typename T,
	    typename Block>
  typename Tensor<T, Block>::template subvector<0, 2>::impl_type
  subview(Tensor<T, Block> ten, index_type idx0, index_type idx1)
...
struct V_slice<2>
{
  ...
  template <typename T,
	    typename Block>
  typename Tensor<T, Block>::template subvector<0, 1>::impl_type
  subview(Tensor<T, Block> ten, index_type idx0, index_type idx1)
...
struct M_slice<0>
{
  ...
  template <typename T,
	    typename Block>
  typename Tensor<T, Block>::template submatrix<0>::impl_type
...
struct M_slice<1>
{
  ...
  template <typename T,
	    typename Block>
  typename Tensor<T, Block>::template submatrix<1>::impl_type
  subview(Tensor<T, Block> ten, index_type i)
...
struct M_slice<2>
{
  ...
  template <typename T,
	    typename Block>
  typename Tensor<T, Block>::template submatrix<2>::impl_type
  subview(Tensor<T, Block> ten, index_type i)
  ...
  MapT const&      map)
{
  ...
  typedef Matrix<T, Dense<2, T, row1_type, Global_map<2> > > global_view2_t;
  ...
  global_view2_t chk_sum(sum_rows, sum_cols);
  chk_sum = root_sum;
  ...
  global_view2_t my_sum(sum_rows, sum_cols, T());
