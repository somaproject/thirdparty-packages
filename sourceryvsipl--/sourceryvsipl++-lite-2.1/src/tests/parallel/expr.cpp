...
/** @file    tests/parallel/expr.cpp
    ...
    @date    2005-05-18
    @brief   VSIPL++ Library: Unit tests for parallel expressions
*/
...

{
  ...
  typedef typename View_of_dim<Dim, T, dist_block_res_t>::type view_res_t;
  typedef typename View_of_dim<Dim, T, dist_block_op1_t>::type view_op1_t;
  typedef typename View_of_dim<Dim, T, dist_block_op2_t>::type view_op2_t;
...

{
  ...
  typedef typename View_of_dim<Dim, T, dist_block_op1_t>::type view_op1_t;
  typedef typename View_of_dim<Dim, T, dist_block_op2_t>::type view_op2_t;
  typedef typename View_of_dim<Dim, T, dist_block_op3_t>::type view_op3_t;
