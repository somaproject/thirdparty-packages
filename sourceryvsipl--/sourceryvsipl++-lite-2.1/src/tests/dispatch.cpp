...
test<O1>()
{
  ...
  int value = 0;
  vsip::impl::dispatch<O1, void, int &, int>(value, 5);
...
test<O2>()
{
  ...
  test_assert((vsip::impl::dispatch<O2, int>(4) == 4));
  test_assert((vsip::impl::dispatch<O2, int>(5) == 5));
}
...
test<O3>()
{
  namespace dispatcher = vsip::impl::dispatcher;
