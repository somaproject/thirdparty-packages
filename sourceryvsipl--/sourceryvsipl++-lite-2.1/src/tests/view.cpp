...
/** @file    tests/view.cpp
    ...
    @date    2005-03-22
    @brief   VSIPL++ Library: Unit tests for views: Vectors, Matrices,
	     and Tesnors.
*/
...
{
  typedef typename vsip::impl::Row_major<Dim>::type row_t;
  typedef typename vsip::impl::Col_major<Dim>::type col_t;
