...
test_proxy(void)
{
  ...
  q = vsip::impl::impl_conj<T>(p);
  // q = vsip::impl::impl_conj(p);

  assert(q        == vsip::impl::impl_conj(a));
  assert(d.get(2) == vsip::impl::impl_conj(a));
...
test_dense_traits()
{
  ...
  VSIP_IMPL_STATIC_ASSERT((
    (vsip::impl::Type_equal< typename vsip::impl::Lvalue_factory_type<Dense<1, T> >::type,
                      vsip::impl::True_lvalue_factory<Dense<1, T> >
    >::value == true) ^ vsip::impl::Is_split_block<Dense<1, T> >::value));
  VSIP_IMPL_STATIC_ASSERT((
    (vsip::impl::Type_equal< typename vsip::impl::Lvalue_factory_type<Dense<2, T> >::type,
                      vsip::impl::True_lvalue_factory<Dense<2, T> >
    >::value == true) ^ vsip::impl::Is_split_block<Dense<2, T> >::value));
  VSIP_IMPL_STATIC_ASSERT((
    (vsip::impl::Type_equal< typename vsip::impl::Lvalue_factory_type<Dense<3, T> >::type,
...
main(int argc, char** argv)
{
  ...
  VSIP_IMPL_STATIC_ASSERT((
    vsip::impl::Type_equal<vsip::impl::Proxy_lvalue_factory<PseudoBlock>::reference_type,
                      vsip::impl::Lvalue_proxy<int, PseudoBlock, 1>
    >::value == true));

  VSIP_IMPL_STATIC_ASSERT((
    vsip::impl::Type_equal<vsip::impl::True_lvalue_factory<PseudoBlock>::reference_type,
  ...
  VSIP_IMPL_STATIC_ASSERT((
    vsip::impl::Type_equal<vsip::impl::Lvalue_factory_type<PseudoBlock>::type,
