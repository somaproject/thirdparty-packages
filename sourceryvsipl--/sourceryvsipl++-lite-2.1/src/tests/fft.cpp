...
test_complex_by_ref(int set, length_type N)
{
  ...
  typedef vsip::impl::Fast_block<1, CT,
    vsip::impl::Layout<1, row1_type,
    vsip::impl::Stride_unit_dense, Complex_format> >
    block_type;
...
test_complex_by_val(int set, length_type N)
{
  ...
  typedef vsip::impl::Fast_block<1, CT,
    vsip::impl::Layout<1, row1_type, vsip::impl::Stride_unit_dense, Complex_format> >
    block_type;
...
test_1d()
{
  test_complex_by_ref<T, vsip::impl::Cmplx_inter_fmt>(2, 64);
  test_complex_by_ref<T, vsip::impl::Cmplx_split_fmt>(2, 64);

  test_complex_by_ref<T, vsip::impl::Cmplx_inter_fmt>(2, 256);
  test_complex_by_ref<T, vsip::impl::Cmplx_split_fmt>(2, 256);

  test_complex_by_val<T, vsip::impl::Cmplx_inter_fmt>(1, 128);
  test_complex_by_val<T, vsip::impl::Cmplx_split_fmt>(1, 128);
  test_complex_by_val<T, vsip::impl::Cmplx_inter_fmt>(2, 256);
  test_complex_by_val<T, vsip::impl::Cmplx_split_fmt>(2, 256);
  test_complex_by_val<T, vsip::impl::Cmplx_inter_fmt>(3, 512);
  test_complex_by_val<T, vsip::impl::Cmplx_split_fmt>(3, 512);

  test_real<T>(1, 128);
  test_real<T>(3, 16);

#if TEST_NON_POWER_OF_2
  test_complex_by_ref<T, vsip::impl::Cmplx_inter_fmt>(1, 68);
  test_complex_by_ref<T, vsip::impl::Cmplx_split_fmt>(1, 68);
  test_complex_by_ref<T, vsip::impl::Cmplx_inter_fmt>(2, 252);
  test_complex_by_ref<T, vsip::impl::Cmplx_split_fmt>(2, 252);
  test_complex_by_ref<T, vsip::impl::Cmplx_inter_fmt>(3, 17);
  test_complex_by_ref<T, vsip::impl::Cmplx_split_fmt>(3, 17);
  test_real<T>(2, 242);
#endif
}
