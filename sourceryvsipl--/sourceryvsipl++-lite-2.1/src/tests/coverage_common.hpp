...
/** @file    tests/expr-coverage.hpp
    ...
    @date    2005-09-13
    @brief   VSIPL++ Library: Coverage tests for expressions.
*/

#ifndef TESTS_COMMON_COVERAGE_HPP
#define TESTS_COMMON_COVERAGE_HPP
...
vector_cases2_mix()
{
  ...
  typedef Storage<1, T1, row1_type, Local_map, Cmplx_inter_fmt> int1_t;
  typedef Storage<1, T2, row1_type, Local_map, Cmplx_inter_fmt> int2_t;
